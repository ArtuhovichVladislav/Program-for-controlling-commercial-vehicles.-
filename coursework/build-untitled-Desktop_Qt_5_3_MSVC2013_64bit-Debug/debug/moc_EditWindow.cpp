...
QT_MOC_LITERAL(8, 83, 11)
    ...
    "EditWindow\0writtenOffChosen\0\0closed\0"
    "okClicked\0cancelClicked\0cbChanged\0"
    "setOkEnabled\0setDisabled"
};
...
void EditWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->writtenOffChosen(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditWindow::writtenOffChosen)) {
                *result = 0;
            }
        }
        {
            typedef void (EditWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditWindow::closed)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject EditWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EditWindow.data,
      qt_meta_data_EditWindow,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void EditWindow::writtenOffChosen()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void EditWindow::closed()
{
